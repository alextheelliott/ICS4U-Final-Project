...
public class Constants {
	...
	public static class LayoutConstants {
		...
		public static final double MENU_BUTTON_SIZE      = 80.0;
		
		public static final double MENU_TEXT_FIELD_WIDTH = 200.0;
		
		public static final String MENU_DROPDOWN_PASSIVE = "file:MenuDropdownPassive.png";
		public static final String MENU_DROPDOWN_HOVER   = "file:MenuDropdownHover.png";
